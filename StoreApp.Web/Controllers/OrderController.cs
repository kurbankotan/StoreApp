...
public class OrderController:Controller
{
    ...
    public IActionResult Checkout(OrderModel model)
    {
        ...
        if(ModelState.IsValid)
        {
            ...
            //Burada kredi kart ödeme yapılmazsa hata mesajları yaz ve aşağıdakileri sil
            model.Cart = cart;
            return  View(model);
    ...
    private Payment ProcessPayment(OrderModel model)
    {
            ...
            options.ApiKey = "sandbox-W6JXTzKs4agCej57UQpqvOrGT2Fs5HiG";
            options.SecretKey = "sandbox-HxcCLqU6JCos9Mh3np3VCFTNXFekMtAG";
